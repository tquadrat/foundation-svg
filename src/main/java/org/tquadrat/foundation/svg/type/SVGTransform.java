 ...
 *  @version $Id: SVGTransform.java 1151 2025-10-01 21:32:15Z tquadrat $
 *  @since 0.0.5
 *
 *  @UMLGraph.link
 */
@SuppressWarnings( "AbstractClassWithoutAbstractMethods" )
@ClassVersion( sourceVersion = "$Id: SVGTransform.java 1151 2025-10-01 21:32:15Z tquadrat $" )
        ...
        SVGTransform.SVGTranslate
{
    ...
    public static final class SVGMatrix extends SVGTransform
    {
         ...
         */
        @SuppressWarnings( {"ConstructorWithTooManyParameters", "StandardVariableNames"} )
    ...
    public static final class SVGScale extends SVGTransform
    {
        ...
        {
            super( SVGTRANSFORM_Scale, longToString( ' ', x, y ) );
        }   //  SVGScale()
        ...
        {
            super( SVGTRANSFORM_Scale, doubleToString( ' ', x, y ) );
        }   //  SVGScale()
        ...
        {
            super( SVGTRANSFORM_Scale, Long.toString( x ) );
        }   //  SVGScale()
        ...
        {
            super( SVGTRANSFORM_Scale, formatDouble( x ) );
        }   //  SVGScale()
    }
    //  class SVGScale
    ...
    public final boolean equals( final Object obj )
    {
        ...
        if( !retValue && (obj instanceof final SVGTransform other) && (getClass() == other.getClass()) )
        {
